...
console.log(_.sortBy(_.uniq(_.flatten(_.map(data,'skills')))));


var friends =_.sortBy(data, 'friends.length');
var name  = _.map(friends, 'name');
console.log(name);


var friends = _.flatten(_.map(data,'friends'));

console.log(_.uniq(_.map(friends,'name')));
